...
INSERT INTO tb_enrollment(user_id, offer_id,enroll_Moment, refund_Moment, avable, only_Update) VALUES (1, 1, TIMESTAMP WITH TIME ZONE '2020-11-20T13:00:00Z', null, true, false);
INSERT INTO tb_enrollment(user_id, offer_id,enroll_Moment, refund_Moment, avable, only_Update) VALUES (2, 1, TIMESTAMP WITH TIME ZONE '2020-11-20T13:00:00Z', null, true, false);

INSERT INTO tb_lesson(title, position, section_id) VALUES ('Aula 1 do cap 1', 1, 1);
INSERT INTO tb_content(id, text_Content, video_Uri) VALUES (1, 'Marial de apoio:', 'https://www.youtube.com/watch?v=xC_yKw3MYX4&t');

INSERT INTO tb_lesson(title, position, section_id) VALUES ('Aula 2 do cap 1', 2, 1);
INSERT INTO tb_content(id, text_Content, video_Uri) VALUES (2, '', 'https://www.youtube.com/watch?v=xC_yKw3MYX4&t');

INSERT INTO tb_lesson(title, position, section_id) VALUES ('Aula 3 do cap 1', 3, 1);
INSERT INTO tb_content(id, text_Content, video_Uri) VALUES (3, '', 'https://www.youtube.com/watch?v=xC_yKw3MYX4&t');
